                ...
                <center>
                    <table cellspacing="0" cellpadding="0" width="600" class="w320">
                        ...
                        <tr>
                          ...
                          <![endif]--><a href="https://www.dev-social.com/empresa/citas.php" style="background-color:#171941;border-radius:5px;color:#ffffff;display:inline-block;font-family:\'Cabin\', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">Mis Citas</a></div>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
...
$mail->addAddress($email);
    ...
    if (!$mail->send()) {
        ...
        header("refresh:0.1 ;url=$referer");
    } else {
